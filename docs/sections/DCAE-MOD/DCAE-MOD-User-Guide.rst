...
See :download:`Configuration JSON for VES Collector <./Sample-Input-Files/ves-deploy.input.json>`

See :download:`Configuration JSON for TCAgen2 <./Sample-Input-Files/tca-deploy.input.json>`
