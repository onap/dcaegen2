...
`registry-initialize.sh <https://github.com/onap/oom/blob/master/kubernetes/contrib/tools/registry-initialize.sh>`__\ ^[https://github.com/onap/oom/blob/master/kubernetes/contrib/tools/registry-initialize.sh]
...
`demo-k8s.sh <https://github.com/onap/oom/blob/master/kubernetes/robot/demo-k8s.sh>`__\ ^[https://github.com/onap/oom/blob/master/kubernetes/robot/demo-k8s.sh]
...
be viewed through kubcel log -f command)
