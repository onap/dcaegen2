...
Domain **perf3gpp** is designed to handle Real Time Performance Management (PM) messages for VNF/PNF.
The purpose of the **perf3gpp** domain is frequent, periodic delivery of structured PM data to ONAP. The equipment sends an event right after collecting the PM data for a granularity period.
