...
By default, **HV-VES** will use routing defined in **k8s-hv-ves.yaml-template** in **dcaegen2/platform/blueprints project**. Current defined domain->topic mapping looks as follows:
...
Currently supported domains can be found in :ref:`supported_domains`
