...
VM configuration as the shared PostgreSQL database for R1 demos.  CCSDK PostgreSQL supports 
multiple deployment configurations including high availability clusters.
(*) Note: This component is delivered under the Holmes project, used as DCAE analytics component 
in R1.
