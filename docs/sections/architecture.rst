...
The following list the components included in ONAP DCAE .  All DCAE components are offered as Docker containers.  Following ONAP level deployment methods, these components can be deployed as Kubernetes Deployments and Services.  
...
- DCAE Services
    ...
    - Analytics
        ...
        - Docker based Threshol Crosssing Analytics
        - Heartbeat Services
        - SON-Handler Service
    - Microservices
