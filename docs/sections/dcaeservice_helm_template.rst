...
installed and run continuously. In the Honolulu release, the other
microservices–the ones that are launched on demand as needed–continued
to be deployed using Cloudify. In the Istanbul release, we are aiming to
move these other microservices to Helm deployment.

Using Helm with DCAE
--------------------
...
The rest of this document describes the different parameters that can be
