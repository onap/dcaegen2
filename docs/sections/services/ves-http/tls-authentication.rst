...
Property *auth.method* is used to manage security mode, possible configuration: noAuth, basicAuth, certOnly, certBasicAuth
    ...
    * *auth.method=certBasicAuth* is used to enable mutual TLS authentication or/and basic HTTPs authentication (https)
    * *auth.method=basicAuth* is used to enable basic HTTPs authentication (https)