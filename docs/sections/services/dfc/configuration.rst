...
------------------------------
**StrictHostChecking** is SSH connection option. If it is enabled, checks HostName and public keys provided by server and comper them with keys stored locally. 
