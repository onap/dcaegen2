...
``streams_publishes`` and ``streams_subscribes`` points to publishing topic and subscribe topic respectively. update these ``urls`` as per your DMaaP configurations in the blueprint. 
