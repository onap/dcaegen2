...
Monitoring
----------
HV-VES collector allows to collect metrics data at runtime. To serve this purpose HV-VES application exposes endpoint **GET /monitoring/prometheus** 
which returns *HTTP 200 OK* and specific data in body. Returned data is in a format readable by Prometheus service.
